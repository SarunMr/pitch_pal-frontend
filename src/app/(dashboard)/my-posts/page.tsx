...
export default function MyPostsPage() {
  ...
  const loadPosts = useCallback(async (pageNum = 1, append = false) => {
    ...
    if (res?.success) {
      ...
      toast.error(res?.message || "Failed to load my posts");
    }
  ...
  const handleLoadMore = () => loadPosts(page + 1, true);
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Manage your posts and updates</p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 space-y-3">
          ...
          <p className="text-sm text-gray-400">Share your thoughts or updates!</p>
          {user && <CreatePostDialog onPostCreated={handlePostCreated} />}
        </div>
      ) : (
        <>
