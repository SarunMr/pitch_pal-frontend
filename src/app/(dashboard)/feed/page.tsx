...
import { Loader2, RefreshCw, Rss, Users } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Community updates and network</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          {user && tab === "recent" && <CreatePostDialog onPostCreated={handlePostCreated} />}
        </div>
      </div>
      ...
      <Tabs value={tab} onValueChange={handleTabChange} className="w-full">
        ...
        <TabsContent value="recent" className="max-w-2xl mx-auto">
          {isLoading ? (
